...
webApp.controller('AssunzioneListCtrl', ['$scope', 'Dipendenza',
	function($scope, Dipendenza) {
		$scope.assunzioni = {};
...
webApp.controller('AssunzioneDetailCtrl', ['$scope', '$rootScope', '$routeParams', '$location', '$dialog', 'Dipendenza',
	function($scope, $rootScope, $routeParams, $location, $dialog, Dipendenza) {
		$rootScope.pageTitle = "Assunzione";
		// Avvio una nuova richiesta
		$scope.a = new Dipendenza().get($routeParams.id,
			function(a) {
				$scope.a = a;
				$rootScope.pageTitle = "Assunzione di " + a.dipendente.nome_cognome;
			}
		);
...
webApp.controller('AssunzioneNewEditCtrl', ['$scope', '$rootScope', '$location', '$dialog', 'Attivita', 'Dipendente',
	function($scope, $rootScope, $location, $dialog, Attivita, Dipendente) {
...
webApp.controller('AssunzioneEditCtrl', ['$scope', '$rootScope', '$routeParams', 'Dipendenza',
	function($scope, $rootScope, $routeParams, Dipendenza) {
		$rootScope.pageTitle = "Modifica assunzione";
		$scope.locked = true;
...
webApp.controller('AssunzioneNewCtrl', ['$scope', '$rootScope', '$location', 'Attivita', 'Dipendente', 'Dipendenza',
	function($scope, $rootScope, $location, Attivita, Dipendente, Dipendenza) {
		$rootScope.pageTitle = "Nuova assunzione";
