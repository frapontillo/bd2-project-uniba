...
webApp.controller('StrutturaListPageCtrl', ['$scope', '$rootScope',
	function($scope, $rootScope) {
		$rootScope.pageTitle = "Strutture";
...
webApp.controller('StrutturaListDialogCtrl', ['$scope', 'dialog',
...
webApp.controller('StrutturaListCtrl', ['$scope', '$rootScope', 'Struttura',
	function($scope, $rootScope, Struttura) {
		$scope.strutture = {};
		$scope.cerca = '';
		$scope.page = 1;
...
webApp.controller('StrutturaDetailCtrl', ['$scope', '$rootScope', '$routeParams', '$location', '$dialog', 'Struttura',
	function($scope, $rootScope, $routeParams, $location, $dialog, Struttura) {
		$rootScope.pageTitle = "Struttura";
		...
		$scope.s = new Struttura().get($routeParams.id, function(s) {
			$rootScope.pageTitle = "Struttura " + $scope.s.codice;
		});
...
webApp.controller('StrutturaNewEditCtrl', ['$scope', '$rootScope', '$location', 'TipoStruttura',
	function($scope, $rootScope, $location, TipoStruttura) {
...
webApp.controller('StrutturaEditCtrl', ['$scope', '$routeParams', '$rootScope', 'Struttura',
	function($scope, $routeParams, $rootScope, Struttura) {
		$rootScope.pageTitle = "Modifica struttura";
		$scope.locked = true;
		$scope.alert = {type:"info", msg:"Carico la struttura..."};

		$scope.s = new Struttura().get($routeParams.id, function(s) {
			$rootScope.pageTitle = "Modifica struttura " + $scope.s.codice;
			$scope.s = s;
			$scope.locked = false;
			$scope.alert = null;
		});
...
webApp.controller('StrutturaNewCtrl', ['$scope', '$rootScope', 'Struttura',
	function($scope, $rootScope, Struttura) {
		$rootScope.pageTitle = "Nuova struttura";
