...
public class PublicFactory extends org.jooq.util.postgres.PostgresFactory {
	...
	private static final long serialVersionUID = -256418432;
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(net.frapontillo.uni.db2.project.jooq.Public.PUBLIC.getName());
	}
}
