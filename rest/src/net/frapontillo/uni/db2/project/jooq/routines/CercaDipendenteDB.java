...
public class CercaDipendenteDB extends org.jooq.impl.AbstractRoutine<java.lang.Object> {
	...
	private static final long serialVersionUID = 495419180;
	...
	public CercaDipendenteDB() {
		super("cerca_dipendente", net.frapontillo.uni.db2.project.jooq.PublicDB.PUBLIC, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("USER-DEFINED"));
	...
	public void setNomecognome(java.lang.String value) {
		setValue(net.frapontillo.uni.db2.project.jooq.routines.CercaDipendenteDB.NOMECOGNOME, value);
	}
